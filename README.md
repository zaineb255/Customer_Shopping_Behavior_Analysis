...
•	Connected Python to SQL Server via SQLAlchemy using local instance
•	Uploaded the cleaned data to SQL Server for advanced analysis.
Data Analysis (SQL Server)
•	Wrote and executed multiple analytical queries to uncover key insights such as:
o	Top products and categories by purchases and revenue
o	Discount effectiveness and review impact
o	Customer segmentation (New, Returning, Loyal)
o	Relationship between repeat buyers and subscription likelihood
3. Visualization & Insights (Power BI)
•	Built an interactive Power BI dashboard (customers.pbix) highlighting:
o	Total revenue and average spend per segment
